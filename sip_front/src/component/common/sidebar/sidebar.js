...
const Sidebar = props => {
  ...
  useEffect(() => {
    ...
    MENUITEMS.map(menuItem => {
      if (menuItem.title === "심신케어") {
        menuItem.children.map(childrenItem => {
          if (childrenItem.visiable) {
            childrenItem.visiable = true;
          }
        });
      }
    });
                  ...
                  {menuItem.children.map((childrenItem, index) => (
                    <Fragment key={index}>
                      ...
                      {childrenItem.type === "sub-header" ? (
                        <li
                          className="iconbar-header sub-header"
                          style={
                            childrenItem.visiable ? { display: "none" } : null
                          }
                        >
                          {childrenItem.title}
                        </li>
